...
public class CharcoalPitPatch
{
    ...
    static void IgniteNow_Prefix(BlockEntityCharcoalPit __instance, ref double ___startingAfterTotalHours)
    {
        ...
        ___startingAfterTotalHours = __instance.Api.World.Calendar.TotalHours + 0.5 * FasterSmeltsModSystem.config.CharcoalPitSpeedRate;
      ...
      ref float ___BurnHours)
    {
      ...
      {
        ___finishedAfterTotalHours = __instance.Api.World.Calendar.TotalHours + (double)___BurnHours * FasterSmeltsModSystem.config.CharcoalPitSpeedRate;
