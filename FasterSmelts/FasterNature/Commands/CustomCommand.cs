...
public class CustomCommand
{
    ...
    public bool RequiresPlayer { get; } = false;
    ...
    public CustomCommand(ICoreServerAPI api, string text, string description, List<string> privileges, bool requiresPlayer, CommandDelegate callback)
    {
        Text = text;
